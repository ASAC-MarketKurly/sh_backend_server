...
//              })
        ...
        List<NewProductItem> response = newProductItems.stream()    // 필터링된 Item 객체들을 NewProductItemResponseDto 로 변환합니다
                .map(NewProductItem::of)                        // Item 객체를 받아 NewProductItemResponseDto 객체로 변환하는 정적 팩토리 메서드 입니다
                .toList();
//              .map((item)-> {
